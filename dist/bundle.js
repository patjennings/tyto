...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return create; });\n/* harmony import */ var _vars__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./vars */ \"./client/js/vars.js\");\n/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./request */ \"./client/js/request.js\");\n/* harmony import */ var _app__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./app */ \"./client/js/app.js\");\n/* harmony import */ var _addBox__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addBox */ \"./client/js/addBox.js\");\n\n\n\n\n\nlet isCreating = null;\nvar st = new _vars__WEBPACK_IMPORTED_MODULE_0__[\"default\"](); // var simplemde;\n\nfunction create(currentPosition) {\n  var long = currentPosition[1];\n  var lat = currentPosition[0];\n  st.isCreating = true; // point où la zone sera créée\n\n  d3.select(\"svg\").append(\"g\").attr(\"longitude\", long).attr(\"latitude\", lat).attr(\"class\", \"creation-spot\").attr(\"transform\", function () {\n    var proj = _vars__WEBPACK_IMPORTED_MODULE_0__[\"projection\"]([lat, long]); // La hauteur dynamique du contenant (.inner-card)\n    // var itemHeight = d3.select(\"svg\").selectAll(\".card\").node().getBoundingClientRect().height\n\n    return \"translate(\" + proj[0] + \", \" + proj[1] + \")\";\n  });\n  d3.select(\".creation-spot\").append(\"circle\").attr(\"cx\", 0).attr(\"cy\", 0).attr(\"r\", 4).attr(\"fill\", \"#FFFF00\");\n  d3.select(\".creation-spot\").append(\"circle\").attr(\"r\", 16).attr(\"fill\", \"#FFFF00\").attr(\"opacity\", 0.2); // create layer w/ input + save button\n\n  var proj = _vars__WEBPACK_IMPORTED_MODULE_0__[\"projection\"]([lat, long]); // var content = \"\";\n\n  var elements = Object(_addBox__WEBPACK_IMPORTED_MODULE_3__[\"default\"])(\"zone\", proj, long, lat);\n  $(\".map\").append(elements);\n  save();\n}\n\nfunction save() {\n  var btnValidate = document.getElementById(\"document-validate\");\n  var btnCancel = document.getElementById(\"document-cancel\");\n  btnValidate.addEventListener('click', function () {\n    console.log(\"save zone\");\n    var titleValue = document.getElementById(\"content-title\").value;\n    var longValue = document.getElementById(\"content-position-long\").value;\n    var latValue = document.getElementById(\"content-position-lat\").value; // var contentValue = simplemde.value();\n    // var contentFormatted = \"title: \"+titleValue+\"\\nposition: \"+latValue+\", \"+longValue+\"\\n\\n---\\n\"+contentValue; // le title intégré dans la desc du markdown\n\n    Object(_request__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(\"POST\", \"includes/SaveZone.php\", \"title=\" + titleValue + \"&latitude=\" + latValue + \"&longitude=\" + longValue, _app__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n  }, false);\n  btnCancel.addEventListener('click', function () {\n    var elem = document.getElementById(\"input-container\");\n    elem.parentNode.removeChild(elem);\n    st.isCreating = false; // console.log(this);\n  }, false);\n}\n\n//# sourceURL=webpack:///./client/js/addZone.js?");
